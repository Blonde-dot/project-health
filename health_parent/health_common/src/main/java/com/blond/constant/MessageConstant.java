...
public class MessageConstant {
    ...
    public static final String GET_IMG_SUCCESS = "获取图片成功";
    public static final String GET_IMG_FAIL = "获取图片失败";
    ...
    public static final String GET_MEMBER_FAIL = "获取当前登录会员信息失败";
    ...
    public static final String ADD_ORDER_SUCCESS = "新增预约信息成功";
    public static final String ADD_ORDER_FAIL = "新增预约信息失败";
    ...
    public static final String PASSWORD_NOT_SAME = "原密码输入错误";
    public static final String ADD_USER_SUCCESS = "添加用户成功";
    public static final String ADD_USER_FAIL = "添加用户失败";
    public static final String EDIT_PASSWORD_SUCCESS = "更新用户密码成功";
    public static final String EDIT_PASSWORD_FAIL = "更新用户密码失败";
    ...
    public static final String GET_BASIC_DATA_SUCCESS = "系统基本数据信息查询成功";
    public static final String GET_BASIC_DATA_FAIL = "系统基本数据信息查询失败";
    public static final String GET_ROLE_SUCCESS = "角色列表查询成功";
    public static final String GET_ROLE_FAIL = "角色列表查询失败";
    public static final String GET_USER_SUCCESS = "用户查询成功";
    public static final String GET_USER_FAIL = "用户查询失败";
    public static final String GET_USER_ROLE_SUCCESS = "用户关联角色查询成功";
    public static final String GET_USER_ROLE_FAIL = "用户关联角色查询失败";
    public static final String EDIT_USER_SUCCESS = "用户信息编辑成功";
    public static final String EDIT_USER_FAIL = "用户信息编辑失败";
    public static final String DELETE_USER_SUCCESS = "用户信息删除成功";
    public static final String DELETE_USER_FAIL = "用户信息删除失败";
    public static final String ADD_PERMISSION_SUCCESS = "添加权限成功";
    public static final String ADD_PERMISSION_FAIL = "添加权限失败";
    public static final String GET_PERMISSION_SUCCESS = "用户拥有权限查询成功";
    public static final String GET_PERMISSION_FAIL = "用户拥有权限查询失败";
    public static final String GET_PERMISSION_ROLE_SUCCESS = "权限关联角色查询成功";
    public static final String GET_PERMISSION_ROLE_FAIL = "权限关联角色查询失败";
    public static final String EDIT_PERMISSION_SUCCESS = "权限信息编辑成功";
    public static final String EDIT_PERMISSION_FAIL = "权限信息编辑失败";
    public static final String DELETE_PERMISSION_SUCCESS = "权限信息删除成功";
    public static final String DELETE_PERMISSION_FAIL = "权限信息删除失败";
}
